...
abstract public class Zoomable extends Pane {
    ...
    public void scale(double scaleDeltaY, Translate scalePosition){
        ...
        if (getPaneScale() * localScaleFactor < maxScale) {
            ...
            // e.g. 0.8 * (1 / 1.2) = 0.67
            if (getPaneScale() * localScaleFactor < 1) {
                localScaleFactor = 1 / getPaneScale();
            }

            // abstract method gets called before the Pane gets scaled
            beforeScale(localScaleFactor);
            ...
            double newScale = getPaneScale() * localScaleFactor;
     ...
     */
    abstract void beforeScale(double scaleFactor);

    /**
     * Gets called after the "zooming" has been completed
     * @param scaleFactor value of the increment/decrement of the zoom
     */
    abstract void afterScale(double scaleFactor);
     ...
     */
    public double getPaneScale() {return this.getScaleX();}
